...
import com.atm.sklepssm.baza.facade.ProduktyFacade;
...
@ManagedBean(name = "produktyController")
@SessionScoped
public class ProduktyController implements Serializable {

    private Produkty current;
    private DataModel items = null;
    @EJB
    private com.atm.sklepssm.baza.facade.ProduktyFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Produkty) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ProduktyCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ProduktyUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ProduktyDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class ProduktyControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Produkty) {
                ...
                return getStringKey(o.getProduktyId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Produkty.class.getName());
            }
        }
    }
}
